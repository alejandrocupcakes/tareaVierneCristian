    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==btnConsultar) {
            if (this.misProcesos.obtenerEstudiante(txtDoc.getText()) != null) {
                ...
                JOptionPane.showMessageDialog(null, "El estudiante no está registrado", "Datos invalidos", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (misProcesos.obtenerEstudiante(txtDoc.getText()) != null) {
                ...
                EstudianteVO estudiante = misProcesos.obtenerEstudiante(txtDoc.getText());
            ...
            this.misProcesos.eliminarEstudiante(txtDoc.getText());
        }
    }
